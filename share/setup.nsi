...
!define MUI_FINISHPAGE_RUN $INSTDIR\Teslacoin-qt.exe
...
OutFile Teslacoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/Teslacoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Teslacoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\CryptogenicBullion.lnk" $INSTDIR\Teslacoin-qt.exe
    ...
    # CryptogenicBullion: URI handling disabled for 0.6.0
        ...
        WriteRegStr HKCR "CryptogenicBullion\DefaultIcon" "" $INSTDIR\Teslacoin-qt.exe
        WriteRegStr HKCR "CryptogenicBullion\shell\open\command" "" '"$INSTDIR\Teslacoin-qt.exe" "$$1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\Teslacoin-qt.exe
